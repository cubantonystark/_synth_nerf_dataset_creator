...
import json, os, time, shutil, glob, random, sys, cv2, signal
    ...
    try:
        ...
        def do_png(delf):
            ...
            try:
                ...
                if (img_heigth != 800 or img_heigth != 800):
                ...
                if "FATAL: command failed" in line:
                ...
                with open(work_dir+"/intrinsics.txt", "w") as instrinsics:
                    ...
                    instrinsics.write("1111.1110311937682 400 400 0.\r0. 0. 0.\r0.\r1.\r")
