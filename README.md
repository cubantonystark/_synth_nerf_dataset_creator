...
Preliminary writeup - I will add more as time allows.
 ...
 This tool was created to leverage the power of [AI葵kwea123](https://github.com/kwea123)'s Lightning fast [NeRF](https://github.com/kwea123/ngp_pl) implementation. It uses the colmap2nerf script from [NVIDIA's Instant NeRF](https://github.com/NVlabs/instant-ngp) implementation and produces a Synthetic NeRF dataset formated like the ones in [Facebook Research NSVF Synthetic NeRF datasets](https://github.com/facebookresearch/NSVF#dataset).<br><br>
