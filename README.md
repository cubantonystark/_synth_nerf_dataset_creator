...
Preliminary writeup - I will add more as time allows.
 ...
 I just put tool to leverage the power of [AI葵kwea123](https://github.com/kwea123)'s amazing pure [pytorch+cuda trained with pytorch-lightning implementation](https://github.com/kwea123/ngp_pl).<br>
